...
CapacitiveSensor cs[] = {
  CapacitiveSensor(23, 13), // Sensor 12
  CapacitiveSensor(23, 12), // Sensor 13
  CapacitiveSensor(23, 10), // Sensor 14
  CapacitiveSensor(23, 9),  // Sensor 15
  CapacitiveSensor(23, 8),  // Sensor 16
  CapacitiveSensor(23, 7),  // Sensor 17
  CapacitiveSensor(23, 6),  // Sensor 18
  CapacitiveSensor(23, 4),  // Sensor 19
  CapacitiveSensor(23, 3),  // Sensor 20
  CapacitiveSensor(23, 2),   // Sensor 21
  CapacitiveSensor(23, 11)  // Sensor 22
};
...
void loop(){
  for(int i = 0; i < NUMBER_OF_SENSORS; i++) {
    ...
    /*Debug*/
    long individual = cs[2].capacitiveSensor(RESOLUTION);
    Serial.println(individual);
    
    if (reading > SENSITIVITY[i]) {
      activateSensor(i);
      Serial.print(reading);
      Serial.print(" = Reading, sesnor is ");
      Serial.print(i+12);
      Serial.println();
    }
    delay(10);
